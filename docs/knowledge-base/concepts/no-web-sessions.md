...
If the browser held a mailbox credential, XSS, shared computers, and “just open the inbox on the laptop” would bypass the signed-app + TOTP-release design. T-9 makes that state impossible rather than “please do not log in.”
...
- `web/js/t9.js` uses `credentials: "omit"`.
